...
public class SInterfaceConcept_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createConstant_qx8fwl_b0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, new BasicCellContext(node), new SubstituteInfoPart[]{new SInterfaceConcept_Editor.ReplaceWith_SStructurePart_cellMenu_a0b0()}));
    return editorCell;
  }
  ...
  public static class ReplaceWith_SStructurePart_cellMenu_a0b0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public ReplaceWith_SStructurePart_cellMenu_a0b0() {
    }
