...
public class SEnumeration_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_lrekv0_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_lrekv0_c0(editorContext, node));
    editorCell.addEditorCell(this.createRefNodeList_lrekv0_d0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_lrekv0_e0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createConstant_lrekv0_c0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "{");
    editorCell.setCellId("Constant_lrekv0_c0");
  ...
  private EditorCell createConstant_lrekv0_e0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "}");
    editorCell.setCellId("Constant_lrekv0_e0");
    default_StyleSheet.getPunctuation(editorCell).apply(editorCell);
    {
      Style style = editorCell.getStyle();
      style.set(StyleAttributes.MATCHING_LABEL, "body-brace");
  ...
  private EditorCell createRefNodeList_lrekv0_d0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new SEnumeration_Editor.membersListHandler_lrekv0_d0(node, "members", editorContext);
  ...
  private static class membersListHandler_lrekv0_d0 extends RefNodeListHandler {
    public membersListHandler_lrekv0_d0(SNode ownerNode, String childRole, EditorContext context) {
