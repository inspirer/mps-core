...
public class MqlFunctionType extends MqlType {
  public static final String concept = "jetbrains.mps.core.query.structure.MqlFunctionType";
  ...
  public static MqlFunctionType newInstance(SModel sm, boolean init) {
    return (MqlFunctionType) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.core.query.structure.MqlFunctionType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
