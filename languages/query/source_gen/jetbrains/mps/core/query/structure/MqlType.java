...
public class MqlType extends BaseConcept {
  public static final String concept = "jetbrains.mps.core.query.structure.MqlType";
  ...
  public static MqlType newInstance(SModel sm, boolean init) {
    return (MqlType) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.core.query.structure.MqlType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
