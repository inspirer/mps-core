...
public class MqlQuery extends BaseConcept implements INamedConcept, MqlParametersContainer, MqlScopeProvider {
  public static final String concept = "jetbrains.mps.core.query.structure.MqlQuery";
  ...
  public static MqlQuery newInstance(SModel sm, boolean init) {
    return (MqlQuery) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.core.query.structure.MqlQuery", sm, GlobalScope.getInstance(), init).getAdapter();
  }
