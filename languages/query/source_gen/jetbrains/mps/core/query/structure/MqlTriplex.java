...
public class MqlTriplex extends MqlExpression {
  public static final String concept = "jetbrains.mps.core.query.structure.MqlTriplex";
  ...
  public static MqlTriplex newInstance(SModel sm, boolean init) {
    return (MqlTriplex) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.core.query.structure.MqlTriplex", sm, GlobalScope.getInstance(), init).getAdapter();
  }
