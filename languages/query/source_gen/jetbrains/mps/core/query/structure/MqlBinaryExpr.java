...
public class MqlBinaryExpr extends MqlExpression {
  public static final String concept = "jetbrains.mps.core.query.structure.MqlBinaryExpr";
  ...
  public static MqlBinaryExpr newInstance(SModel sm, boolean init) {
    return (MqlBinaryExpr) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.core.query.structure.MqlBinaryExpr", sm, GlobalScope.getInstance(), init).getAdapter();
  }
