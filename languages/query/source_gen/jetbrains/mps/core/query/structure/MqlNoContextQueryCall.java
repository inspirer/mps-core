...
public class MqlNoContextQueryCall extends MqlExpression {
  public static final String concept = "jetbrains.mps.core.query.structure.MqlNoContextQueryCall";
  ...
  public static MqlNoContextQueryCall newInstance(SModel sm, boolean init) {
    return (MqlNoContextQueryCall) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.core.query.structure.MqlNoContextQueryCall", sm, GlobalScope.getInstance(), init).getAdapter();
  }
