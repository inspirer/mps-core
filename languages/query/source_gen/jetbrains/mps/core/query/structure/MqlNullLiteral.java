...
public class MqlNullLiteral extends MqlExpression {
  public static final String concept = "jetbrains.mps.core.query.structure.MqlNullLiteral";
  ...
  public static MqlNullLiteral newInstance(SModel sm, boolean init) {
    return (MqlNullLiteral) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.core.query.structure.MqlNullLiteral", sm, GlobalScope.getInstance(), init).getAdapter();
  }
