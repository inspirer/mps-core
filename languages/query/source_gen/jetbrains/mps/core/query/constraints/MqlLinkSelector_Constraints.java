...
public class MqlLinkSelector_Constraints extends BaseConstraintsDescriptor {
  private static SNodePointer breakingNode_3c55os_a0a1a0a0a1a0b0a1a0 = new SNodePointer("r:d2131fa8-9bff-49c9-a7e2-6972f9544c0a(jetbrains.mps.core.query.constraints)", "228266671027861704");

  public MqlLinkSelector_Constraints() {
    super("jetbrains.mps.core.query.structure.MqlLinkSelector");
  }
