...
public class PrecedenceUtil {
  ...
  /*package*/ static SNode getTargetForLeftTransform(SNode context, SNode result) {
    ...
    for (SNode parentNode = SNodeOperations.getParent(targetNode); parentNode != null && SNodeOperations.isInstanceOf(parentNode, "jetbrains.mps.core.query.structure.MqlExpression") && MqlExpression_Behavior.call_getPriority_7352592509980890960(SNodeOperations.cast(parentNode, "jetbrains.mps.core.query.structure.MqlExpression")) < prio; parentNode = SNodeOperations.getParent(targetNode)) {
      if (MqlExpression_Behavior.call_getPriority_7352592509980890960(SNodeOperations.cast(parentNode, "jetbrains.mps.core.query.structure.MqlExpression")) == -1) {
  ...
  public static SNode parenthesiseAndRotateIfNecessary(@NotNull SNode contextNode) {
    if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(contextNode), "jetbrains.mps.core.query.structure.MqlExpression")) {
      int prio = MqlExpression_Behavior.call_getPriority_7352592509980890960(SNodeOperations.cast(SNodeOperations.getParent(contextNode), "jetbrains.mps.core.query.structure.MqlExpression"));
