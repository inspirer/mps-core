...
public class MqlStringLiteral_Behavior {
  ...
  public static SNode virtual_getType_228266671027861783(SNode thisNode) {
    return new MqlStringLiteral_Behavior.QuotationClass_l9s88t_a0a0b().createNode();
  }
  ...
  public static class QuotationClass_l9s88t_a0a0b {
    public QuotationClass_l9s88t_a0a0b() {
    }
