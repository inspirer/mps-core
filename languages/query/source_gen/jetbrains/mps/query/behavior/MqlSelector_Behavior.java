...
public class MqlSelector_Behavior {
  ...
  public static Object call_evaluate_7862448911997337721(SNode thisNode, Object object, EvaluationEnvironment env, EvaluationContext context) {
    BehaviorDescriptor descriptor = ConceptRegistry.getInstance().getBehaviorDescriptorForInstanceNode(thisNode);
    return (Object) descriptor.invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.query.structure.MqlSelector"), "virtual_evaluate_7862448911997337721", PARAMETERS_7862448911997337721, object, env, context);
  }
  ...
  public static Object callSuper_evaluate_7862448911997337721(SNode thisNode, String callerConceptFqName, Object object, EvaluationEnvironment env, EvaluationContext context) {
    return (Object) BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.query.structure.MqlSelector"), callerConceptFqName, "virtual_evaluate_7862448911997337721", PARAMETERS_7862448911997337721, object, env, context);
  }
}
