...
public class MqlExpression_Behavior {
  ...
  public static Object call_evaluate_1671449901154581105(SNode thisNode, EvaluationEnvironment env, EvaluationContext context) {
    BehaviorDescriptor descriptor = ConceptRegistry.getInstance().getBehaviorDescriptorForInstanceNode(thisNode);
    return (Object) descriptor.invoke(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.query.structure.MqlExpression"), "virtual_evaluate_1671449901154581105", PARAMETERS_1671449901154581105, env, context);
  }
  ...
  public static Object callSuper_evaluate_1671449901154581105(SNode thisNode, String callerConceptFqName, EvaluationEnvironment env, EvaluationContext context) {
    return (Object) BehaviorManager.getInstance().invokeSuper(Object.class, SNodeOperations.cast(thisNode, "jetbrains.mps.query.structure.MqlExpression"), callerConceptFqName, "virtual_evaluate_1671449901154581105", PARAMETERS_1671449901154581105, env, context);
  }
}
