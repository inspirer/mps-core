...
public class MqlQuery_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_fwnkly_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_fwnkly_b0(editorContext, node));
  ...
  private EditorCell createCollection_fwnkly_c0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_fwnkly_a2a(editorContext, node));
    editorCell.addEditorCell(this.createRefNodeList_fwnkly_b2a(editorContext, node));
    editorCell.addEditorCell(this.createConstant_fwnkly_c2a(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNodeList_fwnkly_b2a(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new MqlQuery_Editor.parametersListHandler_fwnkly_b2a(node, "parameters", editorContext);
  ...
  private EditorCell createRefNode_fwnkly_e0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createProperty_fwnkly_b0(EditorContext editorContext, SNode node) {
  ...
  private static class parametersListHandler_fwnkly_b2a extends RefNodeListHandler {
    public parametersListHandler_fwnkly_b2a(SNode ownerNode, String childRole, EditorContext context) {
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_fwnkly_a1c0(editorContext, node);
    }
    ...
    private EditorCell createConstant_fwnkly_a1c0(EditorContext editorContext, SNode node) {
      EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "");
      editorCell.setCellId("Constant_fwnkly_a1c0");
      editorCell.setDefaultText("");
      return editorCell;
    }
  }
