...
public class MqlLinkSelector_Constraints extends BaseConstraintsDescriptor {
  private static SNodePointer breakingNode_3c55os_a0a1a0a0a1a0b0a1a0 = new SNodePointer("r:d2131fa8-9bff-49c9-a7e2-6972f9544c0a(jetbrains.mps.query.constraints)", "228266671027861704");

  public MqlLinkSelector_Constraints() {
    super("jetbrains.mps.query.structure.MqlLinkSelector");
  }
        ...
        return new BaseReferenceScopeProvider() {
          ...
          public Object createSearchScopeOrListOfNodes(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            ...
            if (SNodeOperations.isInstanceOf(type, "jetbrains.mps.query.structure.MqlNodeType")) {
              ...
              if ((decl != null)) {
                ListSequence.<SNode>fromList(result).addSequence(ListSequence.<SNode>fromList(SLinkOperations.getTargets(decl, "linkDeclaration", true)));
              }
            }
            return result;
          }
