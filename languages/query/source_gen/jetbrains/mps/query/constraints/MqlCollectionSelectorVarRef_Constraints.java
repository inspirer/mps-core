...
public class MqlCollectionSelectorVarRef_Constraints extends BaseConstraintsDescriptor {
  private static SNodePointer breakingNode_mzpric_a0a1a0a0a1a0b0a1a0 = new SNodePointer("r:d2131fa8-9bff-49c9-a7e2-6972f9544c0a(jetbrains.mps.query.constraints)", "5280308256730768490");

  public MqlCollectionSelectorVarRef_Constraints() {
    super("jetbrains.mps.query.structure.MqlCollectionSelectorVarRef");
  }
