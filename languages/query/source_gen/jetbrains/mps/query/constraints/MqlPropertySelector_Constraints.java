...
public class MqlPropertySelector_Constraints extends BaseConstraintsDescriptor {
  private static Logger LOG = Logger.getLogger(MqlPropertySelector_Constraints.class);
  private static SNodePointer breakingNode_qzbrjt_a0a3a0a0a1a0b0a1a0 = new SNodePointer("r:d2131fa8-9bff-49c9-a7e2-6972f9544c0a(jetbrains.mps.query.constraints)", "228266671027887307");
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseReferenceScopeProvider() {
          ...
          public SNodePointer getSearchScopeValidatorNode() {
            return breakingNode_qzbrjt_a0a3a0a0a1a0b0a1a0;
          }
        };
      }
    });
