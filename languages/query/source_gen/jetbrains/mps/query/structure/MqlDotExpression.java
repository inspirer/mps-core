...
public class MqlDotExpression extends MqlExpression {
  public static final String concept = "jetbrains.mps.query.structure.MqlDotExpression";
  ...
  public static MqlDotExpression newInstance(SModel sm, boolean init) {
    return (MqlDotExpression) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.query.structure.MqlDotExpression", sm, GlobalScope.getInstance(), init).getAdapter();
  }
