...
public class MqlListLiteral extends MqlExpression {
  public static final String concept = "jetbrains.mps.query.structure.MqlListLiteral";
  ...
  public static MqlListLiteral newInstance(SModel sm, boolean init) {
    return (MqlListLiteral) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.query.structure.MqlListLiteral", sm, GlobalScope.getInstance(), init).getAdapter();
  }
