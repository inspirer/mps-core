...
public class MqlPackage extends BaseConcept implements INamedConcept {
  public static final String concept = "jetbrains.mps.query.structure.MqlPackage";
  ...
  public static MqlPackage newInstance(SModel sm, boolean init) {
    return (MqlPackage) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.query.structure.MqlPackage", sm, GlobalScope.getInstance(), init).getAdapter();
  }
