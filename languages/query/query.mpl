...
<language namespace="jetbrains.mps.core.query" uuid="c898d4a2-ef8e-481f-aff5-15e46db05e03" compileInMPS="true" doNotGenerateAdapters="false">
  <models>
    <modelRoot path="${language_descriptor}/languageModels" namespacePrefix="jetbrains.mps.core.query" />
  </models>
  <accessoryModels />
  <generators />
  <sourcePath />
