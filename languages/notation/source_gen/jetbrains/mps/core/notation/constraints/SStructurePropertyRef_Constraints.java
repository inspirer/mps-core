...
public class SStructurePropertyRef_Constraints extends BaseConstraintsDescriptor {
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return breakingNode_dd2wtm_a0a0a0a0a1a0b0a1a1;
          }
          ...
          public Scope createScope(final IOperationContext operationContext, final ReferenceConstraintsContext _context) {
            {
              ...
              if (context != null && !(context.isMultiple()) && SNodeOperations.isInstanceOf(context.getNode(), "jetbrains.mps.core.structure.structure.SAbstractConcept")) {
                return BehaviorReflection.invokeVirtual(Scope.class, SNodeOperations.cast(context.getNode(), "jetbrains.mps.core.structure.structure.SAbstractConcept"), "virtual_getScope_3734116213129936182", new Object[]{SConceptOperations.findConceptDeclaration("jetbrains.mps.core.structure.structure.SProperty"), null});
              }
  ...
  private static SNodePointer breakingNode_dd2wtm_a0a0a0a0a1a0b0a1a1 = new SNodePointer("r:f55d268e-47a6-49d8-8d89-2139ce9c0cd2(jetbrains.mps.core.notation.constraints)", "5566195403254010317");
}
