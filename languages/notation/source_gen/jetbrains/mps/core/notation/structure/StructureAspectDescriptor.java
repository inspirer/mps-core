...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 4:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.notation.structure.SEnumLiteralEntityRef").super_("jetbrains.mps.core.notation.structure.SStructureEntityRef").parents("jetbrains.mps.core.notation.structure.SStructureEntityRef").references("link").create();
      case 5:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.notation.structure.SNamedPattern").super_("jetbrains.mps.core.structure.structure.SStructurePart").parents("jetbrains.mps.core.structure.structure.SStructurePart", "jetbrains.mps.lang.core.structure.INamedConcept").properties("regex").alias("pattern", "").create();
      case 6:
      ...
      case 13:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.notation.structure.SNotationEnumContext").super_("jetbrains.mps.core.notation.structure.SNotationContext").parents("jetbrains.mps.core.notation.structure.SNotationContext").references("element").create();
      case 14:
      ...
      case 18:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.notation.structure.SNotationParentheses").super_("jetbrains.mps.core.notation.structure.SNotationCorePart").parents("jetbrains.mps.core.notation.structure.SNotationCorePart", "jetbrains.mps.core.notation.structure.SNotationPartsContainer").children(new String[]{"separator"}, new boolean[]{false}).alias("(", "").create();
      case 19:
      ...
      case 34:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.notation.structure.SNotationStylesImport").super_("jetbrains.mps.core.structure.structure.SStructurePart").parents("jetbrains.mps.core.structure.structure.SStructurePart").references("source").alias("import styles from", "").create();
      case 35:
      ...
      case 39:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.notation.structure.SNotationTokenRef").super_("jetbrains.mps.core.notation.structure.SNotationCorePart").parents("jetbrains.mps.core.notation.structure.SNotationCorePart").references("token").create();
      case 40:
      ...
      case 45:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.notation.structure.SToken").super_("jetbrains.mps.core.structure.structure.SStructurePart").parents("jetbrains.mps.core.structure.structure.SStructurePart", "jetbrains.mps.lang.core.structure.INamedConcept").properties("regex").children(new String[]{"type"}, new boolean[]{false}).alias("token", "").create();
      case 46:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.notation.structure.STokenConceptType").super_("jetbrains.mps.core.notation.structure.STokenType").parents("jetbrains.mps.core.notation.structure.STokenType").references("concept").create();
      case 47:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.notation.structure.STokenDataType").super_("jetbrains.mps.core.notation.structure.STokenType").parents("jetbrains.mps.core.notation.structure.STokenType").children(new String[]{"dataType"}, new boolean[]{false}).create();
      case 48:
        return new ConceptDescriptorBuilder("jetbrains.mps.core.notation.structure.STokenType").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").abstract_().create();
      default:
        return StructureAspectInterpreted.getInstance().getDescriptor(conceptFqName);
    }
  }

  private static String[] stringSwitchCases_1htk8d_a0a0b = new String[]{"jetbrains.mps.core.notation.structure.SAllNotationsSelector", "jetbrains.mps.core.notation.structure.SAllTermsSelector", "jetbrains.mps.core.notation.structure.SConceptNotationSelector", "jetbrains.mps.core.notation.structure.SConcreteNotationSelector", "jetbrains.mps.core.notation.structure.SEnumLiteralEntityRef", "jetbrains.mps.core.notation.structure.SNamedPattern", "jetbrains.mps.core.notation.structure.SNotation", "jetbrains.mps.core.notation.structure.SNotationBreak", "jetbrains.mps.core.notation.structure.SNotationCall", "jetbrains.mps.core.notation.structure.SNotationConceptContext", "jetbrains.mps.core.notation.structure.SNotationContext", "jetbrains.mps.core.notation.structure.SNotationContextProvider", "jetbrains.mps.core.notation.structure.SNotationCorePart", "jetbrains.mps.core.notation.structure.SNotationEnumContext", "jetbrains.mps.core.notation.structure.SNotationLabel", "jetbrains.mps.core.notation.structure.SNotationMapping", "jetbrains.mps.core.notation.structure.SNotationNewLine", "jetbrains.mps.core.notation.structure.SNotationNospace", "jetbrains.mps.core.notation.structure.SNotationParentheses", "jetbrains.mps.core.notation.structure.SNotationPart", "jetbrains.mps.core.notation.structure.SNotationPartList", "jetbrains.mps.core.notation.structure.SNotationPartWithStyle", "jetbrains.mps.core.notation.structure.SNotationPartsContainer", "jetbrains.mps.core.notation.structure.SNotationPredicate", "jetbrains.mps.core.notation.structure.SNotationQuantifier", "jetbrains.mps.core.notation.structure.SNotationSelector", "jetbrains.mps.core.notation.structure.SNotationStyle", "jetbrains.mps.core.notation.structure.SNotationStyleClass", "jetbrains.mps.core.notation.structure.SNotationStyleColor", "jetbrains.mps.core.notation.structure.SNotationStyleContent", "jetbrains.mps.core.notation.structure.SNotationStyleEmptyLine", "jetbrains.mps.core.notation.structure.SNotationStyleIndent", "jetbrains.mps.core.notation.structure.SNotationStylePart", "jetbrains.mps.core.notation.structure.SNotationStyleSelector", "jetbrains.mps.core.notation.structure.SNotationStylesImport", "jetbrains.mps.core.notation.structure.SNotationTab", "jetbrains.mps.core.notation.structure.SNotationTermClassSelector", "jetbrains.mps.core.notation.structure.SNotationTermSelector", "jetbrains.mps.core.notation.structure.SNotationTermTextSelector", "jetbrains.mps.core.notation.structure.SNotationTokenRef", "jetbrains.mps.core.notation.structure.SNotationUnorderedGroup", "jetbrains.mps.core.notation.structure.SNotationViewPart", "jetbrains.mps.core.notation.structure.SStructureEntityRef", "jetbrains.mps.core.notation.structure.SStructureLinkRef", "jetbrains.mps.core.notation.structure.SStructurePropertyRef", "jetbrains.mps.core.notation.structure.SToken", "jetbrains.mps.core.notation.structure.STokenConceptType", "jetbrains.mps.core.notation.structure.STokenDataType", "jetbrains.mps.core.notation.structure.STokenType"};
}
