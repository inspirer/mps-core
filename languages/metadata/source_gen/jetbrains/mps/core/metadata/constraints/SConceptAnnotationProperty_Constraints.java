...
public class SConceptAnnotationProperty_Constraints extends BaseConstraintsDescriptor {
  ...
  private static Pattern REGEXP_m80s3c_a0a0a1a1a0b0a1a2 = Pattern.compile("[a-zA-Z_][\\w]*", 0);
  ...
  protected Map<String, PropertyConstraintsDescriptor> getNotDefaultProperties() {
    ...
    properties.put("name", new BasePropertyConstraintsDescriptor("name", this) {
      ...
      public boolean validateValue(SNode node, String propertyValue, IScope scope) {
        ...
        return REGEXP_m80s3c_a0a0a1a1a0b0a1a2.matcher((SPropertyOperations.getString(propertyValue))).matches();
      }
    });
    return properties;
  }
