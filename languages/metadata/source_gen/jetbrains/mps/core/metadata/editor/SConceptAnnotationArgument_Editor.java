...
public class SConceptAnnotationArgument_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createProperty_hdpymd_a0a(EditorContext editorContext, SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(editorContext, provider.getCellContext(), new SubstituteInfoPart[]{new SConceptAnnotationArgument_Editor.SConceptAnnotationArgument_name_cellMenu_a0a0a()}));
    SNode attributeConcept = provider.getRoleAttribute();
    Class attributeKind = provider.getRoleAttributeClass();
    if (attributeConcept != null) {
      IOperationContext opContext = editorContext.getOperationContext();
  ...
  private static boolean renderingCondition_hdpymd_a0a(SNode node, EditorContext editorContext, IScope scope) {
    return neq_hdpymd_a0a0a0(SPropertyOperations.getString(node, "name"), "value") || SNodeOperations.getIndexInParent(node) > 0;
  }

  private static boolean neq_hdpymd_a0a0a0(Object a, Object b) {
    return !((a != null ?
      a.equals(b) :
      a == b
    ));
  ...
  public static class SConceptAnnotationArgument_name_cellMenu_a0a0a extends AbstractCellMenuPart_PropertyValues {
    public SConceptAnnotationArgument_name_cellMenu_a0a0a() {
    }
