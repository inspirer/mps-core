...
public class MtlTemplate extends BaseConcept implements MtlEntity, MqlScopeProvider {
  public static final String concept = "jetbrains.mps.core.template.structure.MtlTemplate";
  ...
  public static MtlTemplate newInstance(SModel sm, boolean init) {
    return (MtlTemplate) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.core.template.structure.MtlTemplate", sm, GlobalScope.getInstance(), init).getAdapter();
  }
