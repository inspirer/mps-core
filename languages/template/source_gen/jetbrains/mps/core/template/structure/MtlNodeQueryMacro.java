...
public class MtlNodeQueryMacro extends MtlNodeMacro {
  public static final String concept = "jetbrains.mps.core.template.structure.MtlNodeQueryMacro";
  ...
  public static MtlNodeQueryMacro newInstance(SModel sm, boolean init) {
    return (MtlNodeQueryMacro) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.core.template.structure.MtlNodeQueryMacro", sm, GlobalScope.getInstance(), init).getAdapter();
  }
