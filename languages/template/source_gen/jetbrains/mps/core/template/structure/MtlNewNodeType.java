...
public class MtlNewNodeType extends MqlType {
  public static final String concept = "jetbrains.mps.core.template.structure.MtlNewNodeType";
  ...
  public static MtlNewNodeType newInstance(SModel sm, boolean init) {
    return (MtlNewNodeType) SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.core.template.structure.MtlNewNodeType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
