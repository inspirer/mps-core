...
public class MtlTemplate_Editor extends DefaultNodeEditor {
    ...
    editorCell.setCellId("refNodeList_vars");
    {
      ...
      style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, new AttributeCalculator<Boolean>() {
        public Boolean calculate(EditorCell cell) {
          return MtlTemplate_Editor._StyleParameter_QueryFunction_c4w2e_a0l0((cell == null ?
            null :
            cell.getSNode()
          ), (cell == null ?
            null :
      ...
      style.set(StyleAttributes.INDENT_LAYOUT_INDENT, new AttributeCalculator<Boolean>() {
        public Boolean calculate(EditorCell cell) {
          return MtlTemplate_Editor._StyleParameter_QueryFunction_c4w2e_a1l0((cell == null ?
            null :
            cell.getSNode()
          ), (cell == null ?
            null :
  ...
  private static boolean _StyleParameter_QueryFunction_c4w2e_a0l0(SNode node, EditorContext editorContext) {
  ...
  private static boolean _StyleParameter_QueryFunction_c4w2e_a1l0(SNode node, EditorContext editorContext) {
    return ListSequence.fromList(SLinkOperations.getTargets(SNodeOperations.cast(SNodeOperations.cast(node, "jetbrains.mps.lang.core.structure.BaseConcept"), "jetbrains.mps.core.template.structure.MtlTemplate"), "vars", true)).isNotEmpty();
  }
