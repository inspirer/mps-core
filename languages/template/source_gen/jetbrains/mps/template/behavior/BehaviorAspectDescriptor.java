...
public class BehaviorAspectDescriptor implements jetbrains.mps.smodel.runtime.BehaviorAspectDescriptor {
  private static String[] stringSwitchCases_846f5o_a0a0a = new String[]{"jetbrains.mps.template.structure.MtlBuilder", "jetbrains.mps.template.structure.MtlForeachMacro", "jetbrains.mps.template.structure.MtlForeachVar", "jetbrains.mps.template.structure.MtlIfMacro", "jetbrains.mps.template.structure.MtlLibrary", "jetbrains.mps.template.structure.MtlNewNodeType", "jetbrains.mps.template.structure.MtlNodeQueryMacro", "jetbrains.mps.template.structure.MtlPropertyMacro", "jetbrains.mps.template.structure.MtlQuery", "jetbrains.mps.template.structure.MtlReferenceMacro", "jetbrains.mps.template.structure.MtlTemplate", "jetbrains.mps.template.structure.MtlTemplateRoot"};
