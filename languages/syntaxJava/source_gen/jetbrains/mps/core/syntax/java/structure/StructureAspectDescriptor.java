...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  private static String[] stringSwitchCases_1htk8d_a0a0a = new String[]{"jetbrains.mps.core.syntax.java.structure.SJavaAction", "jetbrains.mps.core.syntax.java.structure.SJavaType", "jetbrains.mps.core.syntax.java.structure.STargetJava"};
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0a, conceptFqName)) {
      case 0:
        return new CompiledConceptDescriptor("jetbrains.mps.core.syntax.java.structure.SJavaAction", "jetbrains.mps.core.syntax.structure.SAction", false, new String[]{"jetbrains.mps.core.syntax.structure.SAction"}, new String[]{}, new String[]{});
      case 1:
