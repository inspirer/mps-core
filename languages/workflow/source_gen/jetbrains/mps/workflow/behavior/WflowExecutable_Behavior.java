    ...
    if (kind == SConceptOperations.findConceptDeclaration("jetbrains.mps.core.query.structure.MqlVariable")) {
      ...
      while (statement != null) {
        if (SNodeOperations.isInstanceOf(statement, "jetbrains.mps.workflow.structure.WflowExpressionStatement")) {
          ListSequence.fromList(res).addElement(SLinkOperations.getTarget(SNodeOperations.cast(statement, "jetbrains.mps.workflow.structure.WflowExpressionStatement"), "var", true));
        }
